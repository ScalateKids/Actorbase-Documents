...
Sbt offre la possibilità di accedere mediante la sua cli alla scala console. Per accedervi è sufficiente lanciare il comando sbt che
...
impostazione di sbt. Per aprire la console scala è sufficiente dare il comando consoleProject su CLI di sbt per avviare la scala
console.
...
progetto dare il comando sbt compile per compilare il progetto e lanciarlo. Alla prima esecuzione tale comando dovrà occuparsi di
...
scaricate.
Se si desidera fare un clean e riscaricare nuovamente da capo scala e librerie sarà sufficente dare il comando sbt clean compile, che
eseguirà un clean del progetto per poi ricompilare il tutto da capo.

\subsubsection{Compilazione di moduli separati}

In caso sia necessario compilare e testare un singolo modulo, viene utilizzato il comando sbt test seguito dal modulo del
progetto che si desidera compilare e testare

\subsubsection{Esecuzione del codice Scala}

Per l'esecuzione del progetto sbt dalla directory home è sufficiente lanciare il comando sbt run che automaticamente eseguirà
