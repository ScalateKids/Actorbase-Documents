...
\item \textbf{Utilizzo:} È stato utilizzato una sola volta per la classe di
connessione all'interno della componente \gloss{CLI} nella classe
\verb=CommandReceiver=, in modo da offrire un unico punto di accesso al
\gloss{server} all'interno dell'interfaccia da linea di comando.
\end{itemize}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.7\textwidth, keepaspectratio]{img/designPattern/Builder.png}
