...
\begin{itemize}
\item \hyperref[sec:actorbase::driver::client::data::Connection]{actorbase::driver::client::data::Connection};
\item \hyperref[sec:actorbase::driver::client::data::ActorbaseCollection]{actorbase::driver::client::data::ActorbaseCollection};
\item \hyperref[sec:actorbase::driver::client::data::ActorbaseCollection]{actorbase::driver::client::data::ActorbaseCollectionMap}.
\end{itemize}
...
\hyperref[sec:actorbase::driver::ActorbaseDriver]{ActorbaseDriver} contenente i
parametri di connessione al \gloss{server}.
