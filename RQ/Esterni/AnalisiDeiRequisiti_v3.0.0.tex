...
\begin{longtable}[H]{|l|p{2cm}|p{6cm}|p{4cm}|}
  ...
  \hline
  OBF1.1.1.1.1 & \multiLineCell{Funzionale\\Obbligatorio} & L'attore di tipo \gloss{HTTPserver} dovrà gestire la ricezione del messaggio Bound & \multiLineCell{INTERNO\\}\\
  \hline
  OBF1.1.1.1.2 & \multiLineCell{Funzionale\\Obbligatorio} & L'attore di tipo \gloss{HTTPserver} dovrà gestire la ricezione del messaggio CommandFailed & \multiLineCell{INTERNO\\}\\
  \hline
  OBF1.1.1.1.3 & \multiLineCell{Funzionale\\Obbligatorio} & L'attore di tipo \gloss{HTTPserver} dovrà gestire la ricezione del messaggio Connected & \multiLineCell{INTERNO\\}\\
  \hline
...
\hline
  ...
  \hline
  OBF2.1.2.1.1 & \multiLineCell{Funzionale\\Obbligatorio} & Il comando di creazione nuova \gloss{collezione} dovrà permettere di inserire il nome della \gloss{collezione} da inserire & \multiLineCell{UC1.3.1.1\\}\\
  \hline
  ...
  \hline
  OBF2.1.2.5.3 & \multiLineCell{Funzionale\\Obbligatorio} & Il comando di aggiunta \gloss{collaboratore} a \gloss{collezione} dovrà permettere l'inserimento del tipo di permesso da applicare al collaboratore sulla \gloss{collezione} & \multiLineCell{UC1.3.5.3\\}\\
  \hline
