...
per la lettura dei dati da disco.
...
\begin{tabular}{| p{3cm} | p{1.5cm} | p{2cm} | p{2cm} | p{8.5cm} |}
  ...
  Nome & Accesso & Mutabilità & Tipo & Descrizione\\
  \hline
  parentRef & pubblica & immutabile & ActorRef & Riferimento all'attore di tipo \gloss{Storefinder} che contiene l'attore di tipo \gloss{Storekeeper} \\
  \hline
  range & pubblica & immutabile & KeyRange & Rappresenta il range di chiavi che sarà contenuto nell'attore\\
  \hline
\end{tabular}
...
\begin{tabular}{| p{3cm} | p{1.5cm} | p{2.5cm} | p{10cm} |}
  ...
  \hline
  \allowbreak{deserializeFromByteArray} & public & \gloss{Any} & Deserializza l'\gloss{array} di \gloss{Byte} parametro riportandolo al formato originale\\
  \hline
  \allowbreak{deserializeFromJSON} & public & \gloss{Any} & Deserializza la stringa \gloss{JSON} parametro riportandola al formato originale\\
  \hline
\end{tabular}
...
\begin{tabular}{| p{5.5cm} | p{1.5cm} | p{2cm} | p{7.5cm} |} %TODO descrizione
  \hline
  Nome & Accesso & Tipo di ritorno & Descrizione\\
  \hline
