...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/keyrange.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/collectionrange.png}
    \caption{Classe actorsystem::utils::CollectionRange}
  \end{center}
\end{figure}

\subparagraph{Descrizione}
Classe atta a modellare un intervallo di chiavi di una specifica \gloss{collezione}.

\subparagraph{Utilizzo}
Viene utilizzata da diversi attori del sistema. Questa classe espone metodi
getter, un metodo per il confronto della \gloss{collezione}, un meotodo per il
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-client.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/response-client.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/mapresponse-client.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/httpserver.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-ware.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/save-ware.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/clean-ware.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removesffolder-ware.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/read-ware.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/adduser-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/login-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/insert-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removeitemfrom-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getitemfrom-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getitemfromresponse-main.png}
...
Messaggio che serve per comporre l'intera \gloss{collezione} da restituire all'utente
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/createcollection-main.png}
...
alla gestione della \gloss{collezione} e aggiornerà la propria struttura dati
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removecollection-main.png}
...
che rappresentano la \gloss{collezione} da rimuovere.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/addcontributor-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removecontributor-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/ack-main.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/duplicationrequestsf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/updatecollectionsize-main.png}
...
Messaggio che incrementa il numero delle coppie chiave-valore alla \gloss{collezione}

\subparagraph{Utilizzo}

Quando \hyperref[sec:actorbase::actorsystem::main::Main]{Main}
riceve questo messaggio provvederà ad inoltrare allo \hyperref[sec:actorbase::actorsystem::userfinder::Userfinder]{Userfinder} l'incremento della \gloss{collezione}.

\subparagraph{Attributi}
\begin{tabular}{| p{3cm} | p{1.5cm} | p{2cm} | p{3.5cm} | p{7.5cm} |}
  \hline
  Nome & Accesso & Mutabilità & Tipo & Descrizione\\
  \hline
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getpasswordof-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/insertto-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getcollectionof-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/changepasswordof-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removecollectionfrom-uf.png}
    \caption{Classe actorsystem::userfinder::messages::RemoveCollectionFrom}
  \end{center}
\end{figure}

\subparagraph{Descrizione}
Messaggio che indica la richiesta di rimozione di una \gloss{collezione} dalla struttura dati dello \hyperref[sec:actorbase::actorsystem::userkeeper::Userkeeper]{actorbase::\allowbreak{}actorsystem::\allowbreak{}userkeeper::\allowbreak{}Userkeeper} corrispondente.
...
\subparagraph{Attributi}
\begin{tabular}{| p{2cm} | p{1.5cm} | p{2cm} | p{3.5cm} | p{8cm} |}
  \hline
  Nome & Accesso & Mutabilità & Tipo & Descrizione\\
  \hline
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/addcollectionto-uf.png}
    \caption{Classe actorsystem::userfinder::messages::AddCollectionTo}
  \end{center}
\end{figure}

\subparagraph{Descrizione}
Messaggio che indica la richiesta di un aggiunta di una \gloss{collezione} con i permessi inseriti ad un utente nel sistema.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/updatecollectionsizeto-uf.png}
...
Messaggio che indica la ncessità di aggiornare il numero di item di una \gloss{collezione}.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getcollection-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/changepassword-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getpassword-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removecollection-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/addcollection-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/bindclient-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/updatecollectionsize-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/duplicationrequestsk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getitem-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removeitem-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/insert-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getallitem-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getallitemfromresponse-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/updatecollectionsize-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/storekeeper.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getitem-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/getallitem-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/insert-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/removeitem-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/updateownerofsk-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/becomestorekeeper-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/becomeninja-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/persist-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/manager.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/classiDiag/messages-manager.png}
...
\subparagraph{Attributi}
\begin{tabular}{| p{2.5cm} | p{1.5cm} | p{2cm} | p{3.5cm} | p{7.5cm} |}
  \hline
  Nome & Accesso & Mutabilità & Tipo & Descrizione \\
  \hline
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/Views.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/PromptProvider.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/Observer.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/CommandLoop.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ActorbaseBanner.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ActorbasePrompt.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ResultViewer.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/CLI-Controllers.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/GrammarParser.png}
    \caption{CLI: package Controllers}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/CLI-Models.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/Command.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/Observable.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/CommandInvoker.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ChangePasswordCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/FindCommand.png}
    \caption{CLI: classe ChangePasswordCommand}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/HelpCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/LogoutCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ResetPasswordCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ListCollectionsCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/AddContributorCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/LoginCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/RemoveCollectionCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/RemoveContributorCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/RenameCollectionCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/AddUserCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/RemoveItemCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/RemoveUserCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ImportCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/InsertItemCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/CreateCollectionCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/ExportCommand.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RQ/CommandReceiver.png}
...
politica di \gloss{routing}. Il MainActor manderà un messaggio allo \hyperref[sec:actorbase::actorsystem::storefinder::StoreFinder]{StoreFinder} relativo il quale manderà un messaggio allo \hyperref[sec:actorbase::actorsystem::storekeeper::StoreKeeper]{StoreKeeper} che dovrà salvarsi l'informazione
sulla propria mappa.\\
...
manda tramite richiesta HTTP al \hyperref[sec:actorbase::actorsystem::clientactor::ClientActor]{ClientActor}.\\
Da questo componente parte il messaggio di Insert(key, value, update) ad un \hyperref[sec:actorbase::actorsystem::main::Main]{Main} scelto in base ad una
politica di \gloss{routing}. Il \hyperref[sec:actorbase::actorsystem::main::Main]{Main} manderà un messaggio allo
...
Nel frattempo l'\gloss{attore} di tipo \hyperref[sec:actorbase::actorsystem::warehouseman::Warehouseman]{Warehouseman} eseguirà un salvataggio
...
Il \hyperref[sec:actorbase::actorsystem::clientactor::ClientActor]{ClientActor} effettuerà l'aggiornamento e risponderà al \gloss{Driver}
...
\begin{longtable}[H]{|p{4.5cm}|p{13cm}|}
  ...
  \hline
  OBF1.1.10.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Authenticator\\actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::clientactor::UserApi\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.1.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Authenticator\\actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.2 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::clientactor::CollectionApi\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  OBF1.1.10.2.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.2.1.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\}\\
  \hline
  OBF1.1.10.2.2 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\}\\
  \hline
  OBF1.1.10.2.3 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.2.3.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.2.3.2 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor}\\
  \hline
  OBF1.1.10.2.4 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  OBF1.1.10.2.4.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\}\\
  \hline
  OBF1.1.10.2.5 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  OBF1.1.10.2.5.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  OBF1.1.10.2.5.2 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  ...
  \hline
  OBF1.1.10.2.6 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  OBF1.1.10.2.6.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\}\\
  \hline
  OBF1.1.10.2.7 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\}\\
  \hline
  OBF1.1.10.3 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::clientactor::ItemApi\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::manager::Manager\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::warehouseman::Warehouseman\\actorbase::actorsystem::clientactor\\}\\
  \hline
  ...
  \hline
  OBF1.1.10.3.2 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  ...
  \hline
  OBF1.1.10.5 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::clientactor::UserApi\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.5.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.6 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::clientactor::UserApi\\}\\
  \hline
  OBF1.1.10.7 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::clientactor::UserApi\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  OBF1.1.10.7.1 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  ...
  \hline
  OBF1.1.10.7.3 & \multiLineCell[t]{actorbase::actorsystem::clientactor::Clientactor\\actorbase::actorsystem::main::Main\\actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::userfinder::Userfinder\\actorbase::actorsystem::userkeeper::Userkeeper\\}\\
  \hline
  ...
  \hline
  OBF1.1.11 & \multiLineCell[t]{actorbase::actorsystem::userfinder::Userfinder\\}\\
  \hline
  OBF1.1.11.1 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::InsertTo\\}\\
  \hline
  OBF1.1.11.2 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::GetPasswordOf\\}\\
  \hline
  OBF1.1.11.3 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::GetCollectionsOf\\}\\
  \hline
  OBF1.1.11.4 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::ChangePasswordOf\\}\\
  \hline
  OBF1.1.11.5 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::RemoveCollectionFrom\\}\\
  \hline
  OBF1.1.11.6 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::AddCollectionTo\\}\\
  \hline
  OBF1.1.11.7 & \multiLineCell[t]{actorbase::actorsystem::userfinder::messages::UpdateCollectionSizeTo\\}\\
  \hline
  ...
  \hline
  OBF1.1.3 & \multiLineCell[t]{actorbase::actorsystem::main::Main\\actorbase::actorsystem::utils::ActorbaseCollection\\actorbase::actorsystem::utils::CollectionRange\\actorbase::actorsystem::utils::KeyRange\\}\\
  \hline
  ...
  \hline
  OBF1.1.4 & \multiLineCell[t]{actorbase::actorsystem::storefinder::Storefinder\\actorbase::actorsystem::utils::ActorbaseCollection\\actorbase::actorsystem::utils::CollectionRange\\actorbase::actorsystem::utils::KeyRange\\}\\
  \hline
  ...
  \hline
  OBF1.1.5 & \multiLineCell[t]{actorbase::actorsystem::storekeeper::Storekeeper\\actorbase::actorsystem::utils::ActorbaseCollection\\actorbase::actorsystem::utils::KeyRange\\}\\
  \hline
  ...
  \hline
  OBF1.1.9 & \multiLineCell[t]{actorbase::actorsystem::userkeeper::Userkeeper\\actorbase::actorsystem::utils::ActorbaseCollection\\}\\
  \hline
