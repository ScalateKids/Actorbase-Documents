...
\item \hyperref[sec:actorbase::driver::serializer]{actorbase::driver::client::api};
...
\begin{itemize}
\item \hyperref{sec:actorbase::driver::ActorbaseDriver};
\item \hyperref{sec:actorbase::driver::data::ActorbaseCollection}.
\end{itemize}
