...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RP/tcpserver.png}
...
Quando \hyperref[sec:actorbase::actorsystem::tcpserver::TCPServer]{actorbase::actorsystem::tcpserver::TCPServer}
riceve questo messaggio associa al \gloss{client} un \gloss{attore} di tipo
\hyperref[sec:actorbase::actorsystem::clientactor::ClientActor]{actorbase::actorsystem::clientactor::ClientActor}.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth,keepaspectratio]{RP/Serialization.png}
...
\gloss{serializzazione} in formato \gloss{RESP}. Viene utilizzata principalmente per
...
Questa classe viene utilizzata per l'implementazione di una strategia di
\gloss{serializzazione} in formato \gloss{Pickle}. Viene utilizzata principalmente per
...
Quando \hyperref[sec:actorbase::actorsystem::storekeeper::Storekeeper]{actorbase::actorsystem::storekeeper::Storekeeper}
riceve questo messaggio inserisce l'\gloss{item}.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RP/Ninja.png}
...
\gloss{Package} che rappresenta l'\gloss{attore} di tipo \gloss{Ninja}.
...
Questa classe viene utilizzata per avere un \gloss{backup} per gli attori di tipo
\hyperref[sec:actorbase::actorsystem::storekeeper::Storekeeper]{actorbase::actorsystem::storekeeper::Storekeeper}.
