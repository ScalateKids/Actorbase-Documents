...
\begin{tabular}{| p{3cm} | p{1.5cm} | p{2cm} | p{2cm} | p{8.5cm} |}
  ...
  Nome & Accesso & Mutabilità & Tipo & Descrizione\\
  \hline
  username & private & immutabile & String & Rappresenta lo \gloss{username} dell'utente\\
  \hline
  password & private & immutabile & String & Rappresenta la password dell'utente\\
  \hline
...
\begin{tabular}{| l | l | l | l |}
  ...
  \hline
  getCollections & public & \hyperref[sec:actorbase::driver::data::ActorbaseCollectionMap]{ActorbaseCollectionMap} & Ritorna un oggetto di tipo \hyperref[sec:actorbase::driver::data::ActorbaseCollectionMap]{ActorbaseCollectionMap}\\
  \hline
...
\begin{tabular}{| p{3cm} | p{1.5cm} | p{2.5cm} | p{10cm} |}
  ...
  Nome & Accesso & Tipo di ritorno & Descrizione\\
  \hline
  find & public & \hyperref[sec:actorbase::driver::data::ActorbaseCollection]{ActorbaseCollection} & Cerca uno o più coppie-chiave valore nelle \gloss{collezioni}\\
  \hline
...
\item  \hyperref[sec:actorbase::view::cli::models::DeleteCollectionCommand]{actorbase::view::cli::models::DeleteCollectionCommand};
...
\item  \hyperref[sec:actorbase::view::cli::models::RemoveCollaboratorCommand]{actorbase::view::cli::models::RemoveCollaboratorCommand};
