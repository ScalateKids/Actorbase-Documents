...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.1\textwidth,keepaspectratio]{RQ/classiDiag/read-ware.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth,keepaspectratio]{RQ/classiDiag/removecollectionfrom-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth,keepaspectratio]{RQ/classiDiag/addcollectionto-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth,keepaspectratio]{RQ/classiDiag/updatecollectionsizeto-uf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/classiDiag/bindclient-uk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth,keepaspectratio]{RQ/classiDiag/duplicationrequestsk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/getitem-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/removeitem-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/classiDiag/insert-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/classiDiag/getallitem-sf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/getitem-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/getallitem-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/removeitem-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/becomestorekeeper-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.2\textwidth,keepaspectratio]{RQ/classiDiag/becomeninja-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.1\textwidth,keepaspectratio]{RQ/classiDiag/persist-sk.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.4\textwidth,keepaspectratio]{RQ/classiDiag/duplicationrequestsf.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth,keepaspectratio]{RQ/ActorbaseServices.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth,keepaspectratio]{RQ/ActorbaseAdminServices.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RQ/Connection.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RQ/ClientInterface.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RQ/Serializer.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/RequestMethod.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/Get.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/Post.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/Put.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.3\textwidth,keepaspectratio]{RQ/Delete.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/WrongCredendtialExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/WrongPasswordExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/WrongNewPasswordExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/CollectionAlreadyExc.png}
    \caption{Driver: class CollectionAlreadyExc}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/UndefinedCollectionExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/UndefinedUsernameExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/UsernameAlreadyExc.png}
    \caption{Driver: class UsernameAlreadyExc}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/DuplicateKeyExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/UndefinedFileExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{RQ/MalformedFileExc.png}
