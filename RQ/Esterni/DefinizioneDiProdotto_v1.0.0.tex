...
\item send
  ...
  \item\textbf{Descrizione:} Rappresenta una richiesta da inviare al server, comprensiva di \gloss{payload} dati
  \end{itemize}
\end{itemize}
...
sono stati già sottoposti al \gloss{parsing}. Questa classe si occupa di inviare
...
Questa classe inoltre chiamerà le componenti necessarie per la \gloss{serializzazione} e \gloss{deserializzazione}
...
\gloss{serializzazione} in formato \gloss{RESP}.
...
rappresentare i dati che verranno ritornati alla \gloss{cli} o al programma
esterno.
