...
\begin{itemize}
	...
	\item \textbf{Driver}: 2,69 tutte le classi sono all'interno del range ottimale a parte Status che però è comunque dentro al range di accettazione;
	\item \textbf{Actorsystem}: 2,39 tutte le classi sono all'interno del range ottimale a parte storekeeper che rientra comunque all'interno del range di accettazione.
\end{itemize}
