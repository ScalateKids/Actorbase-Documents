...
\begin{longtable}[H]{| l | p{10cm} | l | l |}
  ...
  Test & Descrizione & Stato & Requisito\\
  \hline
  TU.OBF1.1.1.1 & Si verifica che All'interno del singolo \gloss{nodo} dovrà essere implementato l'attore \gloss{Tcpserver} per gestire le connessioni provenienti dall'esterno & empty & OBF1.1.1.1   \\
  \hline
  TU.OBF1.1.1.1.1 & Si verifica che L'attore di tipo \gloss{Tcpserver} dovrà gestire la ricezione del messaggio Bound & empty & OBF1.1.1.1.1   \\
  \hline
  TU.OBF1.1.1.1.2 & Si verifica che L'attore di tipo \gloss{Tcpserver} dovrà gestire la ricezione del messaggio CommandFailed  & empty & OBF1.1.1.1.2   \\
  \hline
  TU.OBF1.1.1.1.3 & Si verifica che L'attore di tipo \gloss{Tcpserver} dovrà gestire la ricezione del messaggio Connected  & empty & OBF1.1.1.1.3   \\
  \hline
