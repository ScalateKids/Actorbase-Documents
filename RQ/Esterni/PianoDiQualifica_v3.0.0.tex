...
\paragraph{Complessità ciclomatica}
In questo paragrafo è possibile vedere %cosa se vede?
Complessità ciclomatica entro i range di accettazione:
Actorbase-server: Complessità ciclomatica media 2.93

report oltre il limite:Storefinder.scala(16) e Main.scala(26).

Lato client oltre il limite: GrammarParser.scala(24)
Lato Client totale:
Parte Cli media:2.05;
Parte driver media:1.31;
%TODO

\paragraph{Livelli di annidamento}
Non trovo tool, cmq mi pare nei limiti ad una prima occhiata
%TODO
