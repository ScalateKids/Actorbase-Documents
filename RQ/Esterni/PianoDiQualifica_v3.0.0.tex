...
\begin{longtable}[H]{| l | p{10cm} | l | l |}
  ...
  \hline
  TU.OBF1.1.3.1 & Si verifica che Il sistema ad attori dovrà permettere di inserire \gloss{item} mediante l'interazione tra \gloss{Clientactor}, \gloss{Mainactor}, \gloss{Storefinder}, \gloss{Storekeeper}, \gloss{Ninja} e \gloss{Manager}  & OK  & OBF1.1.3.1   \\
  \hline
  TU.OBF1.1.3.2 & Si verifica che Il sistema ad attori dovrà permettere di creare una \gloss{collezione} nel caso di inserimento \gloss{item} a \gloss{collezione} inesistente mediante interazioni tra \gloss{Clientactor}, \gloss{Mainactor} e \gloss{Userkeeper}.  &   & OBF1.1.3.2   \\
  \hline
  TU.OBF1.1.3.3 & Si verifica che Il sistema ad attori dovrà inviare un messaggio d'errore verso l'esterno nel caso in cui la chiave dell'\gloss{item} da inserire senza sovrascrittura sia già presente, mediante interazioni tra \gloss{Clientactor}, \gloss{Mainactor}, \gloss{Storefinder} e \gloss{Storekeeper}  & OK  & OBF1.1.3.3   \\
  \hline
  ...
  \hline
  TU.OBF1.1.3.10 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione dei messaggi del package storefinder.messages	  & OK  & OBF1.1.3.10   \\
  \hline
  TU.OBF1.1.3.11 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio DuplicationRequestSF	  & OK  & OBF1.1.3.11   \\
  \hline
  TU.OBF1.1.3.12 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio UpdateCollectionSize	  & OK  & OBF1.1.3.12   \\
  \hline
  TU.OBF1.1.3.13 & Si verifica che 	L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio Ack	  & OK  & OBF1.1.3.13   \\
  \hline
  ...
  \hline
  TU.OBF1.1.4.2 & Si verifica che L'attore di tipo \gloss{StoreFinder} dovrà gestire la ricezione del messaggio DuplicationRequestSK  &  OK & OBF1.1.4.2   \\
  \hline
  ...
  \hline
  TU.OBF1.1.4.6 & Si verifica che L'attore di tipo \gloss{StoreFinder} dovrà gestire la ricezione del messaggio GetAllItem  & OK  & OBF1.1.4.6   \\
  \hline
  TU.OBF1.1.4.7 & Si verifica che L'attore di tipo \gloss{StoreFinder} dovrà gestire la ricezione del messaggio GetAllItemResponse  & OK  & OBF1.1.4.7   \\
  \hline
  ...
  \hline
  TU.OBF1.1.6 & Si verifica che L'attore di tipo \gloss{StoreKeeper} dovrà gestire la ricezione del messaggio UpdateOwnerOfSK  & OK & OBF1.1.6    \\
  \hline
  ...
  \hline
  TU.OBF1.1.6.4 & Si verifica che L'attore di tipo \gloss{Warehouseman} dovrà gestire la ricezione del messaggio RemoveSfFolder  & OK  & OBF1.1.6.4    \\
  \hline
  ...
  \hline
  TU.OBF1.1.8.2 & Si verifica che ricezione  &   & OBF1.1.8.2    \\
  \hline
  ...
  \hline
  TU.OBF1.1.9.2 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio UpdateCollectionSize & OK & OBF1.1.9.2    \\
  \hline
