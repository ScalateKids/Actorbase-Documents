...
\begin{longtable}[H]{| l | p{10cm} | l | l |}
  ...
  Test & Descrizione & Stato & Requisito\\
  \hline
  TU.OBF1.1.1.1 & Si verifica che All'interno del singolo \gloss{nodo} dovrà essere implementato l'attore \gloss{HTTPserver} per gestire le connessioni provenienti dall'esterno & OK  & OBF1.1.1.1   \\ 
  \hline
  ...
  \hline
  TU.OBF1.1.2.3 & Si verifica che L'attore di tipo \gloss{Clientactor} dovrà gestire la ricezione della route per gestire la richiesta  & OK  & OBF1.1.2.3   \\
  \hline
  ...
  \hline
  TU.OBF1.1.3 & Si verifica che All'interno del singolo \gloss{nodo} dovrà essere implementato l'attore \gloss{Main} per gestire le richieste provenienti dall'attore \gloss{Clientactor}  & OK  & OBF1.1.3   \\
  \hline
  ...
  \hline
  TU.OBF1.1.3.3 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio RemoveCollection  & OK  & OBF1.1.3.3   \\
  \hline
  TU.OBF1.1.3.4 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio GetItemFrom  &  OK & OBF1.1.3.4   \\
  \hline
  ...
  \hline
  TU.OBF1.1.3.8 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio GetItemFromResponse  & OK  & OBF1.1.3.8   \\
  \hline
  TU.OBF1.1.3.9 & Si verifica che L'attore di tipo \gloss{Main} dovrà gestire la ricezione del messaggio RemoveItemFrom	  & OK  & OBF1.1.3.9   \\
  \hline
  ...
  \hline
  TU.OBF1.1.4.2 & Si verifica che L'attore di tipo \gloss{StoreFinder} dovrà gestire la ricezione del messaggio DuplicateRequestSK  &  OK & OBF1.1.4.2   \\
  \hline
  TU.OBF1.1.4.3 & Si verifica che L'attore di tipo \gloss{StoreFinder} dovrà gestire la ricezione del messaggio GetItem  & OK & OBF1.1.4.3   \\
  \hline
  TU.OBF1.1.4.4 & Si verifica che L'attore di tipo \gloss{StoreFinder} dovrà gestire la ricezione del messaggio RemoveItem  &  OK & OBF1.1.4.4   \\
  \hline
  ...
  \hline
  TU.OBF1.1.5.2 & Si verifica che L'attore di tipo \gloss{StoreKeeper} dovrà gestire la ricezione del messaggio GetItem  &  OK & OBF1.1.5.2    \\
  \hline
  TU.OBF1.1.5.3 & Si verifica che L'attore di tipo \gloss{StoreKeeper} dovrà gestire la ricezione del messaggio GetAllItems  & OK & OBF1.1.5.3    \\
  \hline
  TU.OBF1.1.5.4 & Si verifica che L'attore di tipo \gloss{StoreKeeper} dovrà gestire la ricezione del messaggio Insert  & OK & OBF1.1.5.4    \\
  \hline
  ...
  \hline
  TU.OBF1.1.9 & Si verifica che All'interno del singolo \gloss{nodo} dovrà essere implementato l'attore \gloss{Userkeeper} per gestire gli utenti e i loro permessi sulle \gloss{collezioni}  & OK & OBF1.1.9    \\
  \hline
  TU.OBF1.1.9.1 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio GetCollections   & OK & OBF1.1.9.1    \\
  \hline
  TU.OBF1.1.9.2 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio GetReadCollections  & OK & OBF1.1.9.2    \\
  \hline
  TU.OBF1.1.9.3 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio BindClient  & OK & OBF1.1.9.3    \\
  \hline
  TU.OBF1.1.9.4 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio GetPassword  & OK & OBF1.1.9.4    \\
  \hline
  TU.OBF1.1.9.5 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio RemoveCollection  & OK & OBF1.1.9.5    \\
  \hline
  TU.OBF1.1.9.6 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio AddCollection  & OK & OBF1.1.9.6    \\
  \hline
  TU.OBF1.1.9.7 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio RemoveReadCollection  & OK  & OBF1.1.9.7    \\
  \hline
  TU.OBF1.1.9.8 & Si verifica che L'attore di tipo \gloss{UserKeeper} dovrà gestire la ricezione del messaggio AddReadCollection  & OK & OBF1.1.9.8    \\
  \hline
