...
collections\footnote{A data-structure constituted by a list of key-value items}
...
\begin{itemize}
\item insert methods:\\ These methods come in two variants, first one accepting
