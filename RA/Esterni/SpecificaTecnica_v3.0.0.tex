...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth,keepaspectratio]{RQ/Architettura-AltoLivello.png}% IMMAGINE SBAGLIATA
...
\item \hyperref[sec:actorbase::actorsystem::authactor]{actorbase::actorsystem::authactor};
...
\begin{itemize}
\item \hyperref[sec:actorbase::actorsystem::httpserver::HTTPServer]{actorbase::actorsystem::httpserver::HTTPServer}. %TODO check, does this class exists?
...
%\subsubsection{Package contenuti} da spostare o togliere?
...
\item \hyperref[sec:actorbase::driver::client::ActorbaseClient]{ actorbase::driver::\allowbreak{}client::\allowbreak{}ActorbaseClient}; %TODO non è che sia actorbasedriver?
\item spray.json;
\item spray.routing;
\item akka.actor;
...
\item \hyperref[com::actorbase::actorsystem::clientactor::UserApi]{com::actorbase::actorsystem::clientactor::UserApi};.
...
\subsection{actorbase::actorsystem::clientactor::messages} %TODO SPOSTARE
\label{sec:actorbase::actorsystem::clientactor::messages}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RA/clientactormessages.png}
...
Messaggio che rappresenta la risposta da parte del \gloss{server} ad una ricerca 
che deve restituire più items da inoltrare al \gloss{driver}.
...
%\subsubsection{Package contenuti} TODO togeliere o spostare?
%\begin{itemize}
...
%\subsubsection{Package contenuti} TODO rimuovere o spostare?
%\begin{itemize}
...
\subsection{actorbase::actorsystem::warehouseman::messages} %TODO SPOSTARE
...
\subsection{actorbase::actorsystem::main::messages} %TODO spostare
\label{sec:actorbase::actorsystem::main::messages}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RA/mainmessages.png}
...
\subsubsection{Classi} %TODO mancheranno sicuramente dei messaggi/ ce ne saranno da togliere
...
Quando \hyperref[sec:actorbase::actorsystem::main::Main]{Main}
riceve questo messaggio inoltrerà la richiesta all'attore \hyperref[sec:actorbase::actorsystem::authactor::AuthActor]{AuthActor}.
...
\subsection{actorbase::actorsystem::userfinder} %TODO togliere o sostituire con authactor
...
\paragraph{actorbase::actorsystem::userfinder::Userfinder} %TODO togliere o sostituire con authactor
...
\subsection{actorbase::actorsystem::userfinder::messages} %TODO togliere o sostituire con authactormessages
...
\subsection{actorbase::actorsystem::userkeeper} %TODO togliere o sost con authactor
...
\paragraph{actorbase::actorsystem::userkeeper::Userkeeper} %TODO togliere o sost con authactor
...
\subsection{actorbase::actorsystem::userkeeper::messages} %TODO togliere o sost con authactormess
...
\subparagraph{Utilizzo}
Questa classe viene utilizzata per tener traccia degli attori di tipo
\hyperref[sec:actorbase::actorsystem::storekeeper::Storekeeper]{actorbase::actorsystem::storekeeper::Storekeeper} potendo così scegliere 
...
\subsection{actorbase::actorsystem::storefinder::messages} %TODO spostare
\label{sec:actorbase::actorsystem::storefinder::messages}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RA/storefindermessages.png}
...
\subsubsection{Classi} %TODO CHECK MESSAGES
...
\subsection{actorbase::actorsystem::storekeeper::messages} %TODO spostare
...
\subsection{actorbase::actorsystem::manager::messages} %TODO spostare
\label{sec:actorbase::actorsystem::manager::messages}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\textwidth,keepaspectratio]{RA/managermessages.png}
...
\paragraph{actorbase::actorsystem::manager::messages::DuplicationRequestSK} %TODO cambiare in OneMore
