...
\begin{center}
  \begin{longtable}{| l | l | l | l | p{5cm} |}
    ...
    \hline
    3.1.1 & Alberto De Agostini & Analista & 2016-06-01 & Aggiornamento vincoli password nelle sezioni 3.45, 3.46\\
    \hline
...
\hline
OBF1.1.10.2.3 & \multiLineCell{Funzionale\\Obbligatorio} & Il sistema ad attori dovrà permettere di modificare il nome delle \gloss{collezioni} mediante l'interazione tra \gloss{Clientactor}, \gloss{Mainactor}, \gloss{Storefinder} e \gloss{AuthActor} & \multiLineCell{UC1.3.3\\UC2.2.3\\}\\
\hline
