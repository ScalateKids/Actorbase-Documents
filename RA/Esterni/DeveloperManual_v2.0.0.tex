...
explained at
\url{http://doc.akka.io/docs/akka/2.4.7/general/configuration.html#Listing_of_the_Reference_Configuration}.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth,keepaspectratio]{RQ/DevManual/Default-Config.png}
