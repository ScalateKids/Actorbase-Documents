...
\def\opening#1{\thispagestyle{empty}
  {\centering\fromaddress \vspace{0.6in} \\ % Print the header and from address here, add whitespace to move date down
    \hspace*{\longindentation}16 Giugno 2016\hspace*{\fill}\par} % Print today's date, remove \today to not display it
...
\begin{letter}{}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  Intende inviarLe i documenti necessari al sostenimento della Revisione di Accettazione in data 2016-05-16.
