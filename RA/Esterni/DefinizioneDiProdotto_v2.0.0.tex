...
\item \hyperref[sec:actorbase::actorsystem::messages::mainactormessages]{actorbase::actorsystem::messages::mainactormessages};
...
\subsubsection{Descrizione}
\gloss{Package} contenente i messaggi processabili dall'attore \hyperref[sec:actorbase::actorsystem::authactor::AuthActor]{AuthActor}.
...
Questa classe viene utilizzata per mandare una richiesta all'attore 
\hyperref[sec:actorbase::actorsystem::messages::authactormessages::AuthActor]{AuthActor} 
di accesso al sistema. L'attore \hyperref[sec:actorbase::actorsystem::messages::authactormessages::AuthActor]{AuthActor} 
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/WrongCredentialExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/WrongPasswordExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/WrongNewPasswordExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/CollectionAlreadyExistsExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/UndefinedCollectionExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/UndefinedUsernameExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/UsernameAlreadyExistsExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/DuplicateKeyExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/UndefinedFileExc.png}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\textwidth,keepaspectratio]{RQ/MalformedFileExc.png}
