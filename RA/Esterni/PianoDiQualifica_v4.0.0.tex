...
\begin{longtable}[H]{| l | p{10cm} | l | l |}
  ...
  \hline
  TU.OBF1.1.7.2 & Si verifica che L'attore di tipo \gloss{Ninja} dovrà poter cambiare il proprio contesto ricevendo il messaggio BecomeSK e importare tutti i messaggi dello StoreKeeper &  OK  & OBF1.1.7.2    \\
  \hline
