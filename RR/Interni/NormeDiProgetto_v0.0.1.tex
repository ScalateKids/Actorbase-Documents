...
\end{itemize}
Si occupa della redazione del \texit{Manuale Utente}.
\subsection{Verificatore}
La figura del \texit{Verificatore} partecipa alla realizzazione del prodotto per
...
\begin{itemize}
  \item Si assicura che le attività seguano le direttive stabilite nelle \texit{Norme di Progetto};
  \item Controlla la conformità di ogni stadio del ciclo di vita del prodotto.
\end{itemize}
Si occupa della redazione del \texit{Piano di Qualifica}.
\section{Glossario}
...
\end{center}
Gli \gloss{script} init.sh e update.sh presenti sul server privati saranno
...
\begin{itemize}
  ...
  \item\textbf{extgloss:} estrae tutti i termini da glossario contrassegnati da
    \\gloss dai file del progetto, anche questo comando può essere lanciato con
    o senza argomenti
  \item\textbf{checkgloss:} genera una lista di file da glossario leggendo il
    ...
    progetto eccetto il glossario, e inserisce il comando \\gloss sui termini
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{/home/kids/bin/img/tutorialsRedmine/creaproj1.png}
  \caption{come creare un sottoprogetto - figura 1}
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{/home/kids/bin/img/tutorialsRedmine/creaproj2.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{/home/kids/bin/img/tutorialsRedmine/creamessaggio1.png}
  \caption{come creare un messaggio - figura 1}
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{/home/kids/bin/img/tutorialsRedmine/creamessaggio2.jpg}
...
Una segnalazione rappresenterà un \gloss{task} che il \textit{Responsabile} assegnerà ad uno o più membri del gruppo, questi \gloss{task} possono essere anche suddivisi in diverse sotto attività più semplici.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{/home/kids/bin/img/tutorialsRedmine/creasegn1.png}
  \caption{come creare un segnalazione - figura 1}
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{/home/kids/bin/img/tutorialsRedmine/creasegn2.jpg}
