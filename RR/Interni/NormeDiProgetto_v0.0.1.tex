...
\tableofcontents
\section{Sommario}
\include{NormeDiProgetto-Comunicazioni}
\include{NormeDiProgetto-Riunioni}
\include{NormeDiProgetto-Documenti}
\include{NormeDiProgetto-Glossario}
\include{NormeDiProgetto-AmbienteDiLavoro}
\end{document}
