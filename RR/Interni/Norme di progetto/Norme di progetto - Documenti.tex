...
Abbiamo standardizzato la scrittura di tutti i documenti attraverso un \sum{template} \textit{Latex} creato da noi e presente su \textit{github} nella \sum{repository} \textit{ActorBase - Documents}.
...
\item \textbf{Riferimenti}:
	...
	\end{center}
	\end{itemize}
\item \textbf{Date}: Le date devono essere espresse seguento lo standard \textit{\sum{ISO}} 8601:2004:
	AAAA-MM-GG
...
\item \textbf{Nomi ricorrenti}:
	...
	\item Nomi dei files: i nomi dei files relativi a documenti devono seguire la notazione \textit{\sum{CamelCase}}, seguiti da \textit{_v} e dalla versione del file (es. NormeDiProgetto_v1.0.1.pdf);
