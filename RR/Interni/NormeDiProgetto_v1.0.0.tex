...
Durante l'intera \gloss{attività} di sviluppo del progetto, dalla re del gruppo alla
...
\textit{\gloss{Github}} nel \gloss{repository} \textit{ActorBase -
  Documents}.\gloss{git}(vedi \ref{sec:ServiziWeb}).\\ L'uso del \gloss{template} ci permette di creare una serie di documenti
...
Dal capitolato e dall'\gloss{attività} di \gloss{brainstorming} effettuata inizialmente,
...
\begin{itemize}
  ...
  \item \textbf{Ispection:} questa \gloss{attività} va effettuata solamente quando si ha a disposizione una lista di controllo derivante dalle \gloss{attività} di walkthrough precedenti.\\
...
\begin{itemize}
\item\textbf{ScalaStyle:} \gloss{plugin} per compilatori \gloss{Scala}, fornisce controlli qualitativi esaustivi su \gloss{codice} automaticamente durante la compilazione dei sorgenti;
\item\textbf{loc:} \gloss{script} di controllo qualità, forniscono il rapporto tra righe di \gloss{codice} e righe di commento.
\end{itemize}
...
<<<<<<< HEAD
\gloss{script} necessari al testing a cui sarà adibito. Utilizzato in tandem con
=======
...
l'\textit{Amministratore} hanno stabilito il sistema operatio e '\gloss{IDE} di base ed è stata creato
...
Noi abbiamo deciso di usarla come raccoglitore di \gloss{link} a guide inerenti al nostro progetto.
