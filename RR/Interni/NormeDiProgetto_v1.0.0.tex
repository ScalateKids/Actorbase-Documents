...
\item\textbf{Verifica termini da glossario:} L'operazione è fortemente automatizzabile, compito del \textit{Verificatore} è utilizzare gli strumenti di supporto
  forniti nell'ambiente di lavoro descritti nella sezione \ref{ref:script}. Tuttavia l'\gloss{attività} di verifica finale dovrà essere effettuata secondo il metodo walkthrough;
