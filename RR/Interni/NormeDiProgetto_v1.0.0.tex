...
Per rispondere ad un messaggio presente nel forum è necessario aprire il messaggio voluto e premere su \textbf{Rispondi}. Automaticamente verrà presentato un \gloss{form} \textit{pre compilato} in cui si dovrà solamente inserire il corpo della nostra risposta.
...
\item\textbf{Github:} per tutti i files che necessitano un sistema di \gloss{versionamento} viene usato il servizio offerto da \textit{Github}, l'indirizzo web del gruppo è:\\
  \begin{center}
