...
\begin{titlepage}
  \centering
  \includegraphics[width=0.45\textwidth]{/home/kids/img/logo.png}\par\vspace{1cm}
  \vspace{1.5cm}
...
prevede la creazione di un database \gloss{NoSQL} distribuito di tipo \gloss{key-value} basato
...
Da diversi anni a questa parte per modelli di distribuzione molto grandi i
database a modello \gloss{Relazionale} sono stati "scavalcati" da altri tipi di
database \gloss{NoSQL} tra cui i database \gloss{key-value} poichè possiedono altre
proprietà atte ad implementare diverse strutture applicative. Uno dei più
importanti \gloss{database} di questo tipo al momento è sicuramente \gloss{Amazon DynamoDB}.
...
facile acquisire la padronanza di queste tecnologie e tanto meno padroneggiare il
