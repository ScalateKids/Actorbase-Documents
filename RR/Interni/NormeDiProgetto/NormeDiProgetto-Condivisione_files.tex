...
Per tutti i files che necessitano un sistema di \glossary{versionamento} viene usato il servizio offerto da \textit{Github}, l'indirizzo web del gruppo è:
\begin{center}
...
In tale indirizzo sono poi presenti diverse \glossary{repositories} per suddividire i vari files, sono presenti le \glossary{repository}:
\begin{itemize}
