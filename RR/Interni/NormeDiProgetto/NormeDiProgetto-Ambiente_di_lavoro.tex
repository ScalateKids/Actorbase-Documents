...
\item\textbf{Github:} è usato per tutti i files che necessitano un sistema di \summ{versionamento} viene usato il servizio offerto da \textit{Github}, l'indirizzo web del gruppo è:\\
\begin{center}
