...
\item\textbf{Github:} è usato per tutti i files che necessitano un sistema di \glossary{versionamento} viene usato il servizio offerto da \textit{Github}, l'indirizzo web del gruppo è:\\
\begin{center}
...
\item\textbf{Gantter for Google Drive:} è uno strumento gratuito per la creazione di \glossary{diagrammi di Gantt}, è stato usato per la creazione del Gantt predittivo
\end{itemize}
...
\item\textbf{Gantt:} \textit{Redmine} costruisce automaticamente un \glossary{diagramma di Gantt} con le segnalazioni create dall'\textit{Responsabile}
\end{itemize}
//TODO: potremmo aggiungere dei diagrammi UML2.0 per descrivere come usare redmine...

\paragraph{PHPMyAdmin}
PHPMyAdmin è uno strumento scritto in linguaggio \textit{PHP} che offre una facile amministrazione di \glossary{\textit{database}}.\\
...
Lo strumento scelto è \glossary{git} principalmente per la grande diffusione negli
...
sull'utilizzo del programma in questione. Infine \glossary{git} si è rivelato essere
il più conosciuto tra i membri del gruppo, l'alternativa \glossary{SVN}, nonostante
...
Sono stati creati due \glossary{repository} all'indirizzo \url{https://github.com/actorbase}:
\begin{itemize}
\item Actorbase.\glossary{git}: Contiene i sorgenti del software.
\item Actorbase-Documents.\glossary{git}: Contiene i sorgenti \LaTeX\xspace e i PDF generati.
\end{itemize}
...
l'\textit{Amministratore} hanno stabilito l'\glossary{IDE} di base ed è stata creato
...
\glossary{virtual machine} in modo da garantire omogeneità, e riproducibilità di
...
Per la stesura dei documenti, l'\glossary{IDE} di riferimento è \textbf{TeXstudio}.
