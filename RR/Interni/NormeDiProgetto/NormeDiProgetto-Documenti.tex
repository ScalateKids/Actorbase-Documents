...
Abbiamo standardizzato la scrittura di tutti i documenti attraverso un \glossary{template} \LaTeX\xspace creato da noi e presente su \textit{github} nella \glossary{repository} \textit{ActorBase - Documents}.\\
...
\item \textbf{Riferimenti}:
	...
	\end{center}
	\end{itemize}
\item \textbf{Date}: Le date devono essere espresse seguento lo standard \textit{\glossary{ISO}} 8601:2004:
	AAAA-MM-GG
...
\item \textbf{Nomi ricorrenti}:
	...
	\item Nomi dei files: i nomi dei files relativi a documenti devono seguire la notazione \textit{\glossary{CamelCase}}, seguiti da \textit{_v} e dalla versione del file (es. NormeDiProgetto_v1.0.1.pdf);
