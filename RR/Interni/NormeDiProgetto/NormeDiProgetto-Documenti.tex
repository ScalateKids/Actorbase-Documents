...
Abbiamo standardizzato la scrittura di tutti i documenti attraverso un \summ{template} \textit{Latex} creato da noi e presente su \textit{github} nella \summ{repository} \textit{ActorBase - Documents}.
