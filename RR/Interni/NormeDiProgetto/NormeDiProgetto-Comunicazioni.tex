...
_applicazioni di \summ{instant messaging} quali \textit{Whatsapp} e il suo servizio \textit{Whatsapp Web};
_applicazioni \summ{VoIP} per effettuare audio conferenze con un qualsiasi numero di componenti, quale \textit{TeamSpeak3};
_servizi online per la gestione di una \summ{whiteboard} condivisa, quale \textit{Twiddla};
