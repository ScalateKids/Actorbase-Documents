...
\end{center}
Gli \gloss{script} \verb=init.sh= e \verb=update.sh= presenti sul server privato saranno
...
\item\textbf{build:} lanciato senza argomenti, genera tutti i \gloss{PDF} del
  ...
  .tex, questi verranno allo stesso modo generati eliminando tutti i file \verb=.log
  .aux .out .soc= e \verb=.toc=;
...
\item\textbf{verify:} scansiona tutti i documenti \verb=.tex= del progetto alla
  ...
  \gloss{TODO} o \gloss{merge} irrisolti. Lanciato con l'opzione \verb=-c=
