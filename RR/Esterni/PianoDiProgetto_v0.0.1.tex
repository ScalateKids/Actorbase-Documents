...
\begin{itemize}
\item {L'\glossary{organigramma} del gruppo;}
...
\item {Il rilascio di più \glossary{prototipi} durante lo sviluppo.}
\end{itemize}
...
\glossary{Brainstorming} suddiviso per categorie di pertinenza, in modo da esplorare
...
basandosi sui punti deboli e forti dei componenti con maggiore difficoltà a portare a termine la propria \glossary{attività}.
