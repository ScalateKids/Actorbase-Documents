...
\begin{figure}[H]
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{img/AnalisiConInvestimento.png}
    \caption{Ore con investimento, fase di Analisi}
  \end{subfigure}
  \qquad
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{img/AnalisiConRendicontazione.png}
...
\begin{figure}[H]
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{img/ProgettazioneConInvestimento.png}
    \caption{Ore con investimento, fase di Progettazione}
  \end{subfigure}
  \qquad
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{img/ProgettazioneConRendicontazione.png}
...
\begin{figure}[H]
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{img/CodificaConInvestimento.png}
    \caption{Ore con investimento, fase di Codifica}
  \end{subfigure}
  \qquad
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{img/CodificaConRendicontazione.png}
