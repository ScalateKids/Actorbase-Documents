...
\begin{figure}[H]
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{/home/kids/bin/img/AnalisiConInvestimento.png}
    \caption{Ore con investimento, fase di Analisi}
  \end{subfigure}
  \qquad
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{/home/kids/bin/img/AnalisiConRendicontazione.png}
...
\begin{figure}[H]
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{/home/kids/bin/img/ProgettazioneConInvestimento.png}
    \caption{Ore con investimento, fase di Progettazione}
  \end{subfigure}
  \qquad
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{/home/kids/bin/img/ProgettazioneConRendicontazione.png}
...
\begin{figure}[H]
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{/home/kids/bin/img/CodificaConInvestimento.png}
    \caption{Ore con investimento, fase di Codifica}
  \end{subfigure}
  \qquad
  \begin{subfigure}[H]{0.47\textwidth}
    \includegraphics[width=1.2\textwidth,keepaspectratio]{/home/kids/bin/img/CodificaConRendicontazione.png}
