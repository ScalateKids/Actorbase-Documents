...
\glossDef{Collaboratore} Nell'ambito di Actorbase, con collaboratore si intende un utente (autenticato) che ha visione in collezioni (vedi sotto)  non create da lui stesso
\\
...
\\
  ...
  \glossDef{Item} con item si intende una entry di una collezione (vedi sopra)
  \\
  ...
  \glossDef{Key-value Database} È un paradigma di archiviazione di dati progettato per archiviare, recuperare e gestire array associativi (vedi "Dizionario").
  \\
