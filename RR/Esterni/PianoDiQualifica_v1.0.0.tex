...
Ogni fase descritta in \href{run:./PianoDiProgetto\_v1.0.0.pdf}{Piano di Progetto v1.0.0} necessità di \gloss{attività} di verifica diverse a causa della differenza natura del loro output. Di seguito sono elencate le strategie di verifica usate per ciascuna fase:
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Accettazione}: valori per avere un accentazione del prodotto.
\end{itemize}
