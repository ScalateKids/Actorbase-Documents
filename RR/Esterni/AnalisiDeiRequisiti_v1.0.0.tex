...
\item\textbf{Amministratore:}\\
  Rappresenta un superutente con privilegi di \gloss{visibilità} maggiori rispetto a utenti generici, e poteri di modifica sulla \gloss{visibilità} degli utenti generici.
\end{itemize}
...
\begin{itemize}
\item Ogni utente generico inizialmente ha \gloss{visibilità} solo sulle proprie collezioni e/o su collezioni in collaborazione di proprietà altrui;
...
modo è idealmente possibile ottenere inifita capacità di carico, semplicemente
...
\textbf{Attore primario:} Utente autenticato\\ \\
\textbf{Scopo e descrizione:} L'utente intende elencare tutte le collezioni all'interno di \textbf{Actorbase} secondo la propria \gloss{visibilità}.\\ \\
\textbf{Precodizione:} Il database è pronto a ricevere comandi e l'utente intende elencare le collezioni al suo interno.\\ \\
\textbf{Postcondizione:} Il database restituisce la lista delle collezioni esistenti secondo la \gloss{visibilità} dell'utente.
