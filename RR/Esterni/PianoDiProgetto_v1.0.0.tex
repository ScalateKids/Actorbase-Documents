...
possibile avvere un riscontro immediato dello svolgersi di tutte le attività mediante il \gloss{diagramma di Gantt} fornito dal sistema. Esso si aggiorna dinamicamente segnalando graficamente eventuali ritardi nelle attività pianificate, fornendo una visione intuitiva d'insieme dello stato di progetto.
...
Viene effettuato direttamente dal componente del gruppo quando gli viene assegnato un ticket, e viene costantemente aggiornato ad ogni modifica apportata. Consentendo un aggiornamento dinamico di tutta la pianificazione in modo che sia sempre controllabile lo stato delle date sia dal \gloss{diagramma di Gantt} che dal calendario, a cui hanno accesso tutti i membri del gruppo.
