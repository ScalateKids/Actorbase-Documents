...
\begin{center}
  \begin{tabular}{| l | l | l | l | p{5cm} |}
    ...
    \hline
    1.3.0 & Giacomo Vanin & Verificatore & 2016-03-05 & verifica sezione Casi d'uso\\
    \hline
...
\item Condizione: in UC2.4 l'attore non inserisce una chiave:
  \begin{itemize}
  \item UC2.12\ -\ Visualizzazione della intera \gloss{collezione}
  \end{itemize}
...
\textbf{Scenario principale:}
\begin{itemize}
\item UC2.2.7.1 Inserimento lista \gloss{collezioni} da esportare.
\end{itemize}
\textbf{Postcondizione:} Il contenuto delle \gloss{collezioni} selezionate è stato esportato su file.
...
\end{itemize}
\textbf{Postcondizione:} La lista delle \gloss{collezioni} da esportare è stato inserito correttamente
