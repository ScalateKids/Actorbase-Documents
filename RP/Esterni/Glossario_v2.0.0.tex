...
\begin{center}
  \begin{tabular}{|l | l | l | l | l |}
    ...
    \hline
    1.3.0 & Marco Boseggia & Analista & 2016-03-23 & Verifica definizioni\\
    \hline
...
\glossDef{BSON} è un formato informatico di scambio dati utilizzato principalmente come magazzino dati e formato di trasferimento di rete nel database MongoDB. Si tratta di un formato binario per rappresentare strutture dati semplici e array associativi
\\
...
\glossDef{Business Logic} L'espressione logica di business (in inglese business logic) si riferisce a tutta quella logica applicativa che rende operativa un'applicazione cioè la parte o nucleo (core) di elaborazione.
...
\\
  ...
  \glossDef{Top-Dpwn} strategia di elaborazione dell'informazione e di gestione delle conoscenze, riguardante principalmente il software.
