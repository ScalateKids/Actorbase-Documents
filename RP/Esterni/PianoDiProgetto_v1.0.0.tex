...
Il gruppo si è impegnato molto per l'installazione e l'uso di un ambiente uniforme tra tutti (come da \href{run:../Interni/NormeDiProgetto\_v3.0.0.pdf}{Norme Di Progetto v3.0.0}), questo impegno è stato premiato non riscontrando mai questo tipo di problema.
\paragraph{Impegni personali}
