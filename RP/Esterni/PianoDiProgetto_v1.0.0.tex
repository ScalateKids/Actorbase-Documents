...
%Inoltre la fase di progettazione è stata divisa in due parti ottenendo più pianificazioni brevi rispetto ad una macro pianificazione.
...
Le \gloss{attività} pianificate si sono svolte sforando di alcune ore rispetto a quanto pianificato, con un bilancio in negativo di \textbf{\euro{} 85} che rientra nelle metriche decise nel \href{run:PianoDiQualifica\_v2.0.0.pdf}{Piano di Qualifica v2.0.0}.

\subsection{Progettazione}
\subsubsection{Schedule Variance}
Viene di seguito riportato il consuntivo temporale relativo alla fase di progettazione. L'indice riportato rappresenta lo schedule variance calcolato alla fine del periodo riservato per questa fase di progetto, i valori dello schedule variance sono stati calcolati e salvati nel forum del gruppo e si è scelto di non riportarli in questo documento per evitare verbosità ritenendo opportuno far conoscere lo schedule variance totale dell'intera fase.\\
Di seguito viene riportata in tabella il numero di ore di ritardo o di anticipo per ruolo.
\begin{center}
  \normalsize
  \begin{tabular}{| c | c |}
    \hline
...
Viene di seguito riportato il consuntivo economico relativo alla fase di progettazione e riportate per ogni ruolo lo scarto tra le ore in preventivo e le ore impiegate formando un bilancio per ciascuno di essi.
\begin{center}
  \normalsize
  \begin{tabular}{| c | c | c |}
    \hline
...
\subsubsection{Conclusioni}
Le \gloss{attività} pianificate si sono svolte sforando di molto ore rispetto a quanto pianificato, principalmente questo è stato dovuto a diversi errori fatti durante le attività di analisi della scorsa fase, il gruppo ha dovuto così lavorare più ore del previsto per correggere tali errori e procedere con la progettazione.\\Infine quindi abbiamo ottenuto un bilancio orario in negativo di \textbf{18 ore} e di \textbf{\euro{} 393}.\\ Entrambi i valori sebbene negativi rientrano nei range di accettazione scritti nel \href{run:PianoDiQualifica\_v2.0.0.pdf}{Piano di Qualifica v2.0.0}.
