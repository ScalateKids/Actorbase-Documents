...
attivo e una chiave di ricerca già presente all'interno della \gloss{collezione} designata all'inserimento.\\
\textbf{Precondizione:} Il server è in ascolto, l'attore, con l'intezione di inserire un item con \gloss{flag} di sovrascrittura attivo, ha inserito una chiave di ricerca già presente
...
\item Condizione: in UC2.2.4  l'attore inserisca come nuovo nome il nome di una \gloss{collezione} già censita all'interno del sistema:
  ...
  \item UC2.2.8 Lancio eccezione \gloss{collezione} già esistente.
  \end{itemize}
\item Condizione: in UC2.2.3 l'attore inserisca il nome di una \gloss{collezione} non censita all'interno del sistema:
  \begin{itemize}
  \item UC2.2.9 Lancio eccezione \gloss{collezione} inesistente.
  \end{itemize}
\item Condizione: in UC2.2.4 l'attore inserisca nome di una \gloss{collezione} non censita all'interno del sistema:
  \begin{itemize}
  \item UC2.2.9 Lancio eccezione \gloss{collezione} inesistente.
  \end{itemize}
