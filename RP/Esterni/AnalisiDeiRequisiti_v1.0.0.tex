...
\textbf{Precondizione:} L'utente ha inserito il comando di aiuto generale.\\ \\
...
\textbf{Precondizione:} L'utente ha inserito il comando di aiuto specifico.\\ \\
\textbf{Scenario principale:}
\begin{itemize}
...
\item Nel caso in cui nelle procedure di creazione collezione o modifica nome collezione, l'utente inserisca il nome di una collezione già censita all'iterno del sistema:
  \begin{itemize}
  \item UC1.3.7 Visualizzazione errore \gloss{collezione} già esistente.
  \end{itemize}
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption*{Caso d'uso 1.4.1.1: Operazioni sugli \gloss{item}}
  \end{center}
\end{figure}
\textbf{Attore primario:} Utente autenticato\\ \\
\textbf{Attore secondario} Terminale\\ \\
...
\textbf{Precondizione:} Il server è in ascolto e l'utente intende canellare un item.\\ \\
\textbf{Scenario principale:}
\begin{itemize}
...
\textbf{Precondizione:} Il server è in ascolto e l'utente intende cancellare un item.\\ \\
\textbf{Scenario principale:}
\begin{itemize}
\item L'utente può inserire il valore dell'item.
\end{itemize}
\textbf{Postcondizioni:} La chiave è stata inserita correttamente.
...
\item UC2.2.7 Esportazione di una o più di \gloss{collezionie} su file.
\end{itemize}
\textbf{Estensioni:}
\begin{itemize}
\item Nel caso in cui nella procedura di creazione collezione l'utente inserisca il nome di una collezione già censita all'iterno del sistema:
  \begin{itemize}
    \item UC2.2.8 Lancio eccezione errore \gloss{collezione} già esistente.
  \end{itemize}
...
\item Nel caso in cui l'utente inserisca il nome di una collezione da cancellare inesistente:
  \begin{itemize}
  \item UC2.8 Visualizzazione errore \gloss{collezione} inesistente;
  \end{itemize}
\end{itemize}
\textbf{Postcondizioni:} La \gloss{collezione} è stato cancellata correttamente.
