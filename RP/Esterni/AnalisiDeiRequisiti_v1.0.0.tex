...
\item Condizione: in UC2.3.1 l'attore inserisce un nome collezione non presente nel sistema:
  \begin{itemize}
  \item UC2.2.6 Creazione nuova collezione. % TODO come cazzo facciamo questo?
  \end{itemize}
...
\subserction{UC2.3.3: Lancio eccezione file inesistente}
...
\subserction{UC2.3.4: Lancio eccezione chiave già esistente}
...
\subserction{UC2.3.5: Lancio eccezione collezione inesistente}
...
\subserction{UC2.3.6: Lancio eccezione file malformato}
