...
\textbf{Estensioni:}
\begin{itemize}
  \item Nel caso in cui l'utente inserisca uno username già censita a sistema:
    \begin{itemize}
    \item L'utente non accede al sistema;
    \item UC1.3 Visualizzazione Errore username.
    \end{itemize}
  \item Nel caso in cui l'utente inserisca una password errata:
    \begin{itemize}
    \item L'utente non accede al sistema
    \item UC1.4 Visualizzazione Errore password.
    \end{itemize}
\end{itemize}
