...
\textbf{Scenario principale:}
\begin{itemize}
\item UC3.6.1 Inserimento nome \gloss{collezione};
\item UC3.6.2 Inserimento username \gloss{collaboratore}.
\end{itemize}
...
\textbf{Scenario principale:}
\begin{itemize}
\item UC4.1 Inserimento nuovo \gloss{item};
  \begin{itemize}
  \item UC4.1.1 Inserimento \gloss{item} manuale;
  \item UC4.1.2 Inserimento \gloss{item} item da file.
  \end{itemize}
\item UC4.2 Cancellazione \gloss{item}.
\end{itemize}
\textbf{Estensioni:}
\begin{itemize}
...
\textbf{Scenario principale:}
\begin{itemize}
\item UC4.2.1 Inserimento nome \gloss{collezione};
\item UC4.2.2 Inserimento chiave \gloss{item}.
\end{itemize}
\textbf{Estensioni:}
\begin{itemize}
...
\item Nel caso in cui l'utente inserisca una coppia username-password non riconosciute dal sistema:
  \begin{itemize}
  \item L'utente non accede al sistema;
  \item UC1.3 Visualizzazione Errore credenziali errate.
  \end{itemize}
\end{itemize}
\textbf{Postcondizioni:} L'utente ha acceduto al sistema con successo e risulta essere autenticato.

\subsubsection{UC10.1: Inserimento username}
...
\subsection{UC11.1: Creazione collezione}
...
\subsection{UC11.2: Visualizzazione della lista delle collezioni}
...
\subsection{UC11.3: Modifica nome collezione}
...
\begin{itemize}
\item UC3.3.1 Inserimento nome \gloss{collezione};
\item UC3.3.3 Inserimento nuovo nome \gloss{collezione}.
\end{itemize}
\textbf{Estensioni:}
\begin{itemize}
\item Nel caso in cui l'utente inserisca il nome di una collezione da modificare inesistente:
  \begin{itemize}
  \item UC3.3.2 Visualizzazione errore \gloss{collezione} inesistente;
  \end{itemize}
\item Nel caso in cui l'utente inserisca il nuovo nome di una collezione corrispondente al nome di una collezione già censita all'interno del sistema:
  \begin{itemize}
  \item UC3.3.4 Visualizzazione errore \gloss{collezione} già esistente.
  \end{itemize}
\end{itemize}
\textbf{Postcondizioni:} Il nome della \gloss{collezione} è stato modificato correttamente.

\subsubsection{UC11.3.1: Inserimento nome collezione}
...
\subsection{UC11.4: Cancellazione collezione}
...
\subsubsection{UC11.4.1: Inserimento nome collezione}

\textbf{Attore primario:} Utente autenticato\\ \\
\textbf{Attore secondario:} Terminale\\ \\
\textbf{Scopo e descrizione:} L’utente intende cancellare una \gloss{collezione} presente nel \gloss{database}.\\ \\
\textbf{Precodizione:} Il server è in ascolto e l’utente intende cancellare una \gloss{collezione}, deve inserire il nome della collezione da cancellare.\\ \\
\textbf{Scenario principale:}
\begin{itemize}
...
\subsection{UC11.5: Aggiunta di un collaboratore a collezione}
...
\begin{itemize}
\item UC3.5.1 Inserimento nome \gloss{collezione};
\item UC3.5.3 Inserimento username \gloss{collaboratore}.
\end{itemize}
\textbf{Estensioni:}
...
\subsection{UC11.6: Rimozione di un collaboratore a collezione}

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.7\textwidth,keepaspectratio]{UseCases/UC11_6.png}
    \caption*{Caso d'uso 1: Login}
  \end{center}
\end{figure}
\textbf{Attore primario:} Utente autenticato\\ \\
