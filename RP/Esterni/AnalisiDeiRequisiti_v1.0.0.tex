...
autenticato.\\ \\
\textbf{Precondizione:} Il \gloss{database} è installato correttamente, il server è in ascolto.\\ \\
...
\item Nel caso in cui l'utente utilizzi un comando sconosciuto:
  \begin{itemize}
  \item UC9 Visualizzazione errore comando sconosciuto.
  \end{itemize}
\item Nel caso in cui l'utente inserisca uno username non censito all'interno del sistema:
  \begin{itemize}
  \item L'utente non accede al sistema;
  \item UC1.3 Visualizzazione Errore credenziali errate.
  \end{itemize}
\item Nel caso in cui l'utente inserisca una password errata:
  \begin{itemize}
  \item L'utente non accede al sistema
  \item UC1.4 Visualizzazione Errore credenziali errate.
  \end{itemize}
\end{itemize}
\textbf{Postcondizione:} L'Utente ha acceduto al sistema con successo e risulta essere autenticato.
...
\textbf{Precondizione:} Il \gloss{database} è pronto a ricevere comandi e l'utente intende richiedere supporto, l'utente ha inserito il comando di aiuto generale o ha inserito un comando sconosciuto.\\ \\
\textbf{Scenario principale:}
\begin{itemize}
...
\item Nel caso in cui nella procedura di cancellazione collezione l'utente inserisca il nome di una collezione non censita all'interno del sistema:
  ...
  \end{itemize}
\end{itemize}
\textbf{Postcondizione:} L'operazione richiesta è stata eseguita con successo.
...
\subsection{UC1.4.6: Rimozione di un collaboratore da una propria collezione}
