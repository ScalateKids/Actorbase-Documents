...
\textbf{Scenario principale:}
\begin{itemize}
\item L'attore inserisce nome \gloss{collezione}.
\end{itemize}
...
\textbf{Scopo e descrizione:}
L'attore ha inserito un comando tra:
\begin{itemize}
...
\textbf{Precondizioni:} Il server è in ascolto, l'attore ha inserito il %finire tutti i casi di errore qua sotto
