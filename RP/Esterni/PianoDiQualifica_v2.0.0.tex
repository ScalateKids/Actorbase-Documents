...
I test di integrazione permettono di verificare la corretta integrazione ed il corretto flusso
dei dati all'interno del sistema, sia relazioni tra \gloss{package} sia il funzionamento
di ogni singolo \gloss{package} di ogni componente.\\
L'approccio utilizzato è di tipo top-down, il diagramma seguente non rispetta il formalismo
\gloss{UML} 2.0 ed è utilizzato per semplificare la strategia di integrazione:
\begin{figure}[H]
  \begin{center}
