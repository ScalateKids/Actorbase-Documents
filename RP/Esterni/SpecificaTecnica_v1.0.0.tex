...
\item\textbf{Librerie Java:} La possibilità di usufruire di molte librerie Java, pur essendo
  ...
  per liguaggio Java, e questo può portare a difficili comprensioni del comportamento della libreria
...
\begin{itemize}
\item akka::actor::ActorRef;
\item \hyperref[actorbase::actorsystem::main::SFRange]{actorbase::actorsystem::main::SFRange}.
\end{itemize}

\paragraph{actorbase::actorsystem::storefinder::SFRange}
\label{sec:actorbase::actorsystem::storefinder::SFRange}
...
\begin{itemize}
\item \hyperref[actorbase::actorsystem::main::Main]{actorbase::actorsystem::main::Main}.
\end{itemize}
...
che, se ricevuto dall'attore di tipo \gloss{Main},
...
Classe che rappresenta un attore di tipo \gloss{Storefinder}.
...
\begin{itemize}
\item akka::actor::ActorRef;
\item \hyperref[actorbase::actorsystem::storefinder::SKRange]{actorbase::actorsystem::storefinder::SKRange}.
\end{itemize}
...
\begin{itemize}
\item \hyperref[actorbase::actorsystem::storefinder::Storefinder]{actorbase::actorsystem::storefinder::Storefinder}.
\end{itemize}
...
Messaggio che, se ricevuto dall'attore di tipo \gloss{Storefinder},
...
\gloss{Package} che rappresenta l'attore di tipo \gloss{Storekeeper}.
...
Messaggio che richiede un \gloss{item} contenuto dall'attore
\gloss{Storekeeper} che lo riceve.

\subparagraph{Utilizzo}

Quando \hyperref[sec:actorbase::actorsystem::storekeeper::Storekeeper]{actorbase::actorsystem::storekeeper::Storekeeper}
riceve questo messaggio risponde mandando l'\gloss{item} cercato all'attore di tipo
\hyperref[sec:actorbase::actorsystem::clientactor::ClientActor]{actorbase::actorsystem::clientactor::ClientActor}
...
Messaggio che richiede gli \gloss{item} contenuti dall'attore
\gloss{Storekeeper} che lo riceve.

\subparagraph{Utilizzo}

Quando \hyperref[sec:actorbase::actorsystem::storekeeper::Storekeeper]{actorbase::actorsystem::storekeeper::Storekeeper}
riceve questo messaggio risponde mandando gli \gloss{item} all'attore di tipo
\hyperref[sec:actorbase::actorsystem::clientactor::ClientActor]{actorbase::actorsystem::clientactor::ClientActor}
che aveva effettuato la richiesta.
...
\gloss{Package} che rappresenta l'attore di tipo \gloss{Ninja}.
...
Messaggio che richiede che l'attore di tipo \gloss{Ninja} diventi di tipo
\gloss{Storekeeper}.
...
\gloss{Package} che rappresenta l'attore di tipo \gloss{Manager}.
