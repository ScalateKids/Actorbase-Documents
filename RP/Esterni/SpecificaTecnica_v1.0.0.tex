...
assimilabili ad un paradigma \gloss{Client}-Server, il sistema ad attori dove risiedono
...
\item \textbf{Errors} rappresentano stringhe di errore, formate da:
  ...
  \end{center}
  verranno utilizzate per generare le eccezioni lato \gloss{client}; il primo byte è ``-'';
