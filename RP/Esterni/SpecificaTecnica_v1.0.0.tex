...
actorbase::cli::controllers::GrammarParser chiamando il metodo opportuno che
implementa l'interfaccia actorbase::cli::models::Command.
...
riferimento a actorbase::cli::models::CommandReceiver per l'esecuzione del
comando.
...
\begin{itemize}
\item actorbase::cli::models::CommandInvoker;
\item actorbase::view::cli::models::CommandReceiver.
\end{itemize}
...
actorbase::cli::models::CommandReceiver per la ricerca con i parametri immessi
dall'utente.
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per il logout.
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per il reset della password
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la visualizzazione dell'elenco dei
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per l'aggiunta di un collaboratore a
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per il login con le credenziali
immesse dall'utente.
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la rimozione di una collezione con
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la rimozione di un collaboratore
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la rinominazione di un item con i
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per l'aggiunta di un utente con i
parametri specificati in input.
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la rimozione di un \gloss{item}
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la rimozione di un utente con i
parametri immessi dall'utente.
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per l'importazione da un file
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per l'inserimento di un \gloss{item}
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per la creazione di una nuova
...
Viene utilizzata per chiamare il metodo di
actorbase::cli::models::CommandReceiver per l'esportazione in file
\gloss{JSON} con i parametri immessi dall'utente.
...
Viene utilizzata da actorbase::cli::models::Command per chiamare actorbase::driver::client::ActorbaseClient.
