...
\begin{center}
  \begin{tabular}{| l | l | l | l | p{5cm} |}
    ...
    \hline
    0.0.4 & Andrea Giacomo Baldan & Progettista & 2016-03-17 & Stesura sottosezioni 4.1 4.2 4.3 4.4 4.5\\
    \hline
    0.0.3 & Andrea Giacomo Baldan & Progettista & 2016-03-17 & Stesura sottosezioni 3.1 3.2\\
    \hline
...
\gloss{MVC}, le tre componenti principali si prestano naturalemente
...
\gloss{Package} per la componente \gloss{Controller} dell'architettura \gloss{MVC}, rappresenta anche la componente Driver del prodotto.

\subsubsection{Package contenuti}

\begin{itemize}
\item ActorbaseClient;
\item Connection;
\item Controls.
\end{itemize}

\subsection{Actorbase::View\ -\ Command Line Interface}

\subsubsection{Descrizione}

\gloss{Package} per la componente \gloss{View} dell'architettura \gloss{MVC}, rappresenta anche la componente \gloss{CLI} del prodotto.
...
\subsection{Actorbase::View::ActorbaseView}
...
\begin{itemize}
\item Actorbase::View::Commands;
\item \gloss{Spring Shell}.
\end{itemize}

\subsubsection{Classi}

\paragraph{Actorbase::View::ActorbaseView::PromptProvider}
...
\begin{itemize}
\item Actorbase::View::ActorbaseView::DefaultPromptProvider;
\item Actorbase::View::ActorbaseView::SpringShell.
\end{itemize}

\paragraph{Actorbase::View::ActorbaseView::HistoryFileNameProvider}
...
\begin{itemize}
\item Actorbase::View::ActorbaseView::DefaultFilenameProvider;
\item Actorbase::View::ActorbaseView::SpringShell.
\end{itemize}

\paragraph{Actorbase::View::ActorbaseView::BannerProvider}
...
\begin{itemize}
\item Actorbase::View::ActorbaseView::DefaultBannerProvider;
\item Actorbase::View::ActorbaseView::SpringShell.
\end{itemize}

\paragraph{Actorbase::View::ActorbaseView::CLICommands}
...
\begin{itemize}
\item Actorbase::View::ActorbaseView::CommandMarker;
\item Actorbase::View::ActorbaseView::SpringShell.
\end{itemize}
...
\begin{itemize}
\item Actorbase::View::ActorbaseView::Commands::Command.
\end{itemize}

\paragraph{Actorbase::View::ActorbaseView::ResultViewer}

\subparagraph{Descrizione}

Classe per la gestione e la formattazione in output dei risultati ottenuti dall'input.
