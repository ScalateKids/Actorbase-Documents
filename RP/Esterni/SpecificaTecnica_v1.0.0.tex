...
\item\textbf{Implementazione del \gloss{modello ad attori}:} \gloss{Akka}
  ...
  possibile creare facilmente applicazioni message-driven estremamente concorrenti e
...
\begin{itemize}
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::actorclient};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::tcpserver};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::storefinder};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::storekeeper};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::warehouseman};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::ninja};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::manager};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::userkeeper};
\item \hyperref[sec::actorbase::actorsystem::actorclient]{sec::actorbase::actorsystem::serialization}.
\end{itemize}

\subsubsection{Interazioni con altre componenti}

\begin{itemize}
\item \hyperref[sec::actorbase::driver]{sec::actorbase::driver};
\item Akka
\end{itemize}
