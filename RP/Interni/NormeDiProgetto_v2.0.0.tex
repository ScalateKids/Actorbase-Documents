...
in cui essa è contenuta separati da una coppia di duepunti.\\ Qui possiamo
vedere un esempio:
...
particolare i \gloss{progettisti} avranno il compito di realizzare i seguenti
rispettando le regole imposte dallo standard \gloss{UML}
2.0: %TODO interfacce lollipop?
\begin{itemize}
